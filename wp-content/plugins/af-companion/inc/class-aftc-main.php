...
544 -175 544 -129 0 21 -31 403 -33 411 -1 4 -26 -11 -56 -33z"/>
    ...
    public function display_plugin_page()
    {
        ...
        <div class="aftc  wrap  about-wrap">
            ...
            <h1 class="aftc__title"><?php esc_html_e('AF Companion', 'af-companion'); ?></h1>
                    ...
                    <div class="aftc__gl-item-container  wp-clearfix  js-aftc-gl-item-container">
                        <?php foreach ($predefined_themes as $index => $import_file) :
                            ...
                            <div class="aftc__gl-item js-aftc-gl-item"
                                ...
                                <div class="aftc__gl-item-footer<?php echo !empty($import_file['preview_url']) ? '  aftc__gl-item-footer--with-preview' : ''; ?>">
                                    ...
                                    <div class="aftaftc__gl-item-btn-wrap">
                                        <?php if ($import_file['upgrade'] == false): ?>
                                            <button class="aftc__gl-item-button  button  button-primary  js-aftc-gl-import-data"
                                                    value="<?php echo esc_attr($index); ?>"><?php esc_html_e('Import', 'af-companion'); ?></button>
                                        <?php else:
                                            ?>
    ...
    public function import_demo_data_ajax_callback()
    {
        ...
        if (empty($this->frontend_error_messages)) {
            $response['message'] = sprintf(
                __('%1$sThat\'s it, all done!%2$sThe demo import has finished. Please check your page and make sure that everything has imported correctly. We\'ll continue to develop exciting new features for free in the future by sharing the love! For more beautiful WordPress products please visit %3$sAF themes%4$s. %5$s', 'af-companion'),
