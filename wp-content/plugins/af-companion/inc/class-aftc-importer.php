<?php
/**
 * Class for declaring the importer used in the AF Companion plugin
 *
 * @package aftc
 */
...
class AFTC_Importer {
	...
	public function __construct( $importer_options = array(), $logger = null ) {
		...
		$this->importer = new AFTC_WXR_Importer( $importer_options );
	...
	private function include_required_files() {
		...
		require AFTC_PATH . 'inc/class-aftc-wxr-importer.php';
	}
